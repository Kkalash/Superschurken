    ...
    public synchronized static ArrayList<SuperSchurke> getSuberSchurken() {
        if (mSuperSchurken == null) {
            ...
            mSuperSchurken.add(
                    ...
                    new String[]{"Handlanger", "Luthors Massenmörder"},
            ...
            mSuperSchurken.add(
                    ...
                    new String[]{ "Übermenschliche Stärke", "High-Tech-Kampfgleiter",
                    "Gepanzerte Flugrüstung", "Kobold-Granaten" },
       ...
       "https://schurken.fandom.com/de/wiki/Gr%C3%BCner_Kobold_(Spider-Man-Filmtrilogie)")
            ...
            mSuperSchurken.add(new SuperSchurke(
                    ...
                    new String[]{"Geschäftsmann", "Gangster", "Politiker"},
            ...
            mSuperSchurken.add(new SuperSchurke(
                    ...
                    new String[]{"Anführer der Saviors"},
            ...
            mSuperSchurken.add(new SuperSchurke(
                    ...
                    new String[]{"HYDRA-Leiter", "Wissenschaftler", "Wächter des Seelensteins"},
            ...
            mSuperSchurken.add(new SuperSchurke(
                    ...
                    new String[]{ "Elektrizität erschaffen", "Energieblitze erschaffen",
            ...
            mSuperSchurken.add(new SuperSchurke(
                    ...
                    new String[]{"Biker", "Gang-Anführer", "Drogendealer"},
            ...
            mSuperSchurken.add(new SuperSchurke(
                    ...
                    new String[]{"Archäologin (vormals)", "Superschurkin"},
                    new String[]{ "Extreme Stärke und Geschwindigkeit", "Ferale Instinkte",
                            "Scharfe Klauen und Zähne", "Genialer Verstand" }, new String[]{ "-" },
                    "-", R.drawable.cheetah,
